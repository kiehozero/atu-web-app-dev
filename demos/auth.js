...
// Function to create a new user and store it in the user's array
function createUser(username, password){
    users.push({ username, password});
    console.log(users); // Log the current state of the user's array
}

// Function to authenticate a user based on their username and password
function authenticateUser(username, password){
    // Find the user with the given username in the user's array
